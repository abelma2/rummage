...
2. **Choose it** — you tweak the detected ingredients (remove misreads, add what
   the camera missed) and optionally narrow things down: dietary filters, how much
   time you have (quick, a bit, or plenty), how easy you want it, and what you can
   cook with (microwave only, oven only, and so on). Claude then suggests a menu of
   dish ideas — cheap to generate, since they're just titles, not full recipes.
